...
namespace SalaryCalc
{
    class FilePath
    {
        ...
        static string LIST_HOURS_MANAGER = FILE_PATH + @"\..\manager.json";
        static string LIST_HOURS_WORKER = FILE_PATH + @"\..\worker.json";
        static string LIST_HOURS_Frilancer = FILE_PATH + @"\..\frilancer.json";
    }
}
